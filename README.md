...
이에 카카오톡처럼 1:1 채팅이 가능한 데스크탑 App 을 제작해보고 싶어 만들게 되었습니다!
...
- firebase 의 공식문서 내용 외에 추가적인 내용 숙지를 위해 포털사이트에 검색하면,  
  이전 버전의 사용 방법들이 대부분이였다.  
  그래서 공식문서를 읽고 또 읽으며 firebase 를 심도있게 공부하였고, 공식문서와 친해질 수 있었다.  
  그리고 이러한 과정에서 다양한 해결 방법과 디버깅 능력을 향상시킬 수 있었던 것 같다!
- 1:1 채팅앱은 보안 및 조건설정이 관건이였다. 로그인 여부, 로그인된 유저의 여부에 따라 보여지면 안되면 내용들이 있었기에  
  코드 작성하기 전 필요한 조건과 로직을 더 많이 고민하고 설정하는 능력을 기를 수 있었다.
